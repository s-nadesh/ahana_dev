app.controller('opNonRecuringreportController', ['$rootScope', '$scope', '$timeout', '$http', '$state', '$anchorScroll', '$filter', '$timeout', function ($rootScope, $scope, $timeout, $http, $state, $anchorScroll, $filter, $timeout) {
        ...
        $scope.loadReport = function () {
            ...
            $http.post($rootScope.IRISOrgServiceUrl + '/patientconsultant/getcharges', data)
