app.controller('IpincomereportController', ['$rootScope', '$scope', '$timeout', '$http', '$state', '$anchorScroll', '$filter', '$timeout', function ($rootScope, $scope, $timeout, $http, $state, $anchorScroll, $filter, $timeout) {
        ...
        $scope.loadReport = function () {
            ...
            $http.post($rootScope.IRISOrgServiceUrl + '/patientbillingpayment/getincomereport', data)
