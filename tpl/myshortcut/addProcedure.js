app.controller('ProcedureController', ['$rootScope', '$scope', '$timeout', '$http', '$state', '$filter', function ($rootScope, $scope, $timeout, $http, $state, $filter) {
        ...
        $scope.saveForm = function () {
            ...
            method = 'POST';
            succ_msg = 'Patient Procedure saved successfully';
