app.controller('newpurchaseReportController', ['$rootScope', '$scope', '$timeout', '$http', '$state', '$anchorScroll', '$filter', '$timeout', function ($rootScope, $scope, $timeout, $http, $state, $anchorScroll, $filter, $timeout) {
        ...
        $scope.loadReport = function () {
            ...
            $http.post($rootScope.IRISOrgServiceUrl + '/pharmacyreport/newpurchasereport?addtfields=new_purchasereport', data)
