...
(function ($) {
    ...
    $.fn.pk_family = function (options) {
        familyObj = new pwnFamily(options);
    ...
    $.getFamily = function () {
        ...
        var data = JSON.stringify(familyObj.family);
        return data;
    }
    ...
    var pwnFamily = function (options) {
        ...
        if (options.initFamily) {
            this.initFamily = options.initFamily;
        }
        return this;
    }
    pwnFamily.prototype = {
...
//                if (this.family[parentId].child && this.family[parentId].child.length > 1) {
        ...
        createOptionsMenu: function () {
            ...
            liRemove.click(function (event) {
                root.removeMember(root.selectedMember, root.selectedElement);
                $(root.options_menu).css('display', 'none');
            });
            // cancel the pop menu
        ...
        inintalizeBlankFamily: function () {
            ...
            for (var key in members) {
                ...
                this.addMember({
                    ...
                    age: member.age,
                    pic: member.pic
                }, member.parentId, member.relation);
            }
//            // just for testing
//            this.addMember({id: 0, name: "test one", gender: "M", age: "34", pic: "img/profile.png"}, -1, '');
//            this.addMember({id: -1, name: "child one", gender: "M", age: "34", pic: "img/profile.png"}, 0, 'child');
//            this.addMember({id: -1, name: "child two", gender: "M", age: "34", pic: "img/profile.png"}, 0, 'child');
//            this.addMember({id: -1, name: "child three", gender: "M", age: "34", pic: "img/profile.png"}, 0, 'child');
//            this.addMember({id: -1, name: "father one", gender: "M", age: "34", pic: "img/profile.png"}, 0, 'father');
//            this.addMember({id: -1, name: "spouse one", gender: "F", age: "34", pic: "img/profile-f.png"}, 0, 'spouse');
//            this.addMember({id: -1, name: "mother one", gender: "F", age: "34", pic: "img/profile-f.png"}, 0, 'mother');
//            this.addMember({id: -1, name: "sister one", gender: "F", age: "34", pic: "img/profile-f.png"}, 0, 'sibling');
//            this.addMember({id: -1, name: "brother one", gender: "M", age: "30", pic: "img/profile.png"}, 0, 'sibling');
        },
...
//                }
        ...
        addMember: function (member, to, relation) {
            ...
            if (to != -1) {
                ...
                this.family[newMemberId].relation = relation;
            }
            return newMemberId;
        },
        ...
        saveMember: function () {
            ...
            if ($('#pk-isediting').val() == '1') {
                ...
                member.gender = $('#pk-gender').val();
                member.age = $('#pk-age').val();
                member.pic = 'img/profile.png';
                if (member.gender == 'Female') {
                    member.gender = 'F';
                    member.pic = 'img/profile-f.png';
                } else {
                    member.gender = 'M';
                }
                var parentId = 0;
